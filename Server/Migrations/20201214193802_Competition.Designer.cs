...
namespace server.Migrations
{
    ...
    [Migration("20201214193802_Competition")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Fixture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.GoLiveHubModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.Fixture", b =>
                {
                    ...
                    b.HasOne("Models.Team", "Team1")
                        .WithMany()
                        .HasForeignKey("Team1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.Team", "Team2")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.NotificationModel", b =>
                {
                    b.HasOne("Models.Players", "Player")
                        .WithMany()
